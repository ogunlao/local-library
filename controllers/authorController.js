...
exports.author_create_post = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      res.render('forms/author_form', { title: 'Create Author', author: req.body, errors: errors.array() });
      return;
    }
    else {
...
exports.author_delete_get = function (req, res, next) {
  ...
  async.parallel({
    ...
    // Successful, so render.
    res.render('forms/author_delete', { title: 'Delete Author', author: results.author, author_books: results.authors_books });
  });
...
exports.author_update_get = function (req, res) {
  Author.findById(req.params.id)
    .exec(function (err, author) {
      if (err) { return next(err); }
      // Successful, so render
      res.render('forms/author_form', { title: 'Update Author', author: author });
    });
...
exports.author_update_post = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      // There are errors. Render form again with sanitized values/errors messages.
      res.render('forms/author_form', { title: 'Create Author', author: author, errors: errors.array() });
      return;
    }
    else {
        // Data from form is valid.
