...
exports.genre_create_post = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      res.render('forms/genre_form', { title: 'Create Genre', genre: genre, errors: errors.array() });
      return;
    }
    else {
...
exports.genre_delete_get = function (req, res) {
  async.parallel({
    ...
    // Successful, so render.
    res.render('forms/genre_delete', { title: 'Delete Genre', genre: results.genre, genre_books: results.genres_books });
  });
};
...
exports.genre_update_get = function (req, res) {
  ...
  .exec(function (err, genre) {
    if (err) { return next(err); }
    // Successful, so render
    res.render('forms/genre_form', { title: 'Update Genre', genre: genre });
  });
};
